...
-- Drop the type with CASCADE to remove dependent objects
...
-- Drop the account table if it exists to ensure it is recreated with the correct structure
DROP TABLE IF EXISTS public.account;

-- Recreate the account table with the account_type column
...
VALUES   (
    ...
    'Hummer',
    '2016',
    'Do you have 6 kids and like to go offroading? The Hummer gives you a huge interiors with an engine to get you out of any muddy or rocky situation.',
    '/images/hummer.jpg',
